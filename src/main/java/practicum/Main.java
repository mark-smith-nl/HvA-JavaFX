...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if(!isDatabaseConfigured()) {
            ...
            System.err.println("If executing a jar: java -DdatabaseType=POSTGRES -Dpassword=<pwd> -jar <path_to_jar>");
            System.err.println("If executing from IntelliJ: add '-DdatabaseType=POSTGRES -Dpassword=<pwd>' to the VM options of the corresponding run configuration.");
            System.exit(1);
        } else {
